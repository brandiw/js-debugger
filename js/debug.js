...
var (width = 5);
var (height = 7);{
  console.log("z is 5 ", z.getWidth(), "inches wide."); //expect "z is 5 inches wide"
}
  ...
  console.log(actorofThecentury, "is a God of excellence and beauty");{
  } //should print "Nicolas Cage is a God of excellence and beauty" which is also true.

  var (bestMovieEver = "American Treasure");{
  console.log(bestMovieEver);}
  //should print "American Treasure"


  var (document.getElementById("finish").innerText = "YOU'RE ALL DONE!!");{
